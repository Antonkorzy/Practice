...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПредставительОУLabel" runat="server" Text="Представитель ОУ" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlПредставительОУ" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

<asp:RequiredFieldValidator ID="ctrlПредставительОУValidator" runat="server" ControlToValidate="ctrlПредставительОУ"
ErrorMessage="Не указано: ПредставительОУ" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПредставительОУ_ИмяLabel" runat="server" Text="Имя" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlПредставительОУ_Имя" runat="server" ReadOnly="true">
</asp:TextBox>
