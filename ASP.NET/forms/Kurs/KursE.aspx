...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Информация о </h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНазваниееLabel" runat="server" Text="Номер группы" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlНазваниее" runat="server">
</asp:TextBox>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlГодLabel" runat="server" Text="Курс" EnableViewState="False">
</asp:Label>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlОУLabel" runat="server" Text="Образовательное учреждение" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlОУ" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlОУ_НазваниеLabel" runat="server" Text="" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlОУ_Название" runat="server" ReadOnly="true">
</asp:TextBox>
