...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="KursE.aspx.cs" Inherits="IIS.MyApp.КурсE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНазваниееLabel" runat="server" Text="Названиее" EnableViewState="False">
</asp:Label>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlОУLabel" runat="server" Text="ОУ" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlОУ" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlОУ_НазваниеLabel" runat="server" Text="Название" EnableViewState="False">
</asp:Label>
