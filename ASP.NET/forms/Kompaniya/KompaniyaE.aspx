...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="KompaniyaE.aspx.cs" Inherits="IIS.MyApp.КомпанияE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlПрактикиИнфоLabel" runat="server" Text="Практики инфо" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlПрактикиИнфо" runat="server">
</asp:TextBox>
